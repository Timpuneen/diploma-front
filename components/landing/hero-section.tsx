...
export function HeroSection() {
  ...
  const stats = [
    { value: t.hero.statAccuracy, label: t.hero.statAccuracyLabel },
    { value: t.hero.statLanguages, label: t.hero.statLanguagesLabel },
    { value: t.hero.statTime, label: t.hero.statTimeLabel },
  ];
